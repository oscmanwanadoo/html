...
//
// verficiacion de creacion de vectores
//
//var VG=new Vector (SCL_PO, PtoCoordGlob);
//VG.escribe();
...
function dibujaObjetoDesplazado (Objeto1, SistCoord, escala, contexto, corrector)
	{ 
	var numAristas = Objeto1.Arista.length;
	...
	for (var nArista=0; nArista< numAristas; nArista++)
		...
		var nVini = Objeto1.Arista[nArista][0] - corrector;
		var nVfin = Objeto1.Arista[nArista][1] - corrector;
		...
		var P0_X = Objeto1.Vertice[nVini][0];
		var P0_Y = Objeto1.Vertice[nVini][1];
		var P0_Z = Objeto1.Vertice[nVini][2];

		var P1_X = Objeto1.Vertice[nVfin][0];
		var P1_Y = Objeto1.Vertice[nVfin][1];
		var P1_Z = Objeto1.Vertice[nVfin][2];

		var PL0 = new Punto3D(	escala * P0_X, 
								escala * P0_Y, 
								escala * P0_Z);
		var PL1 = new Punto3D(	escala * P1_X, 
								escala * P1_Y, 
								escala * P1_Z);
		
		//document.write("inicio envio datos a coord globales...<br>);
...
// document.write("<br>inicio rotacion punto vector<br>");
...
var PtoP = new Punto3D (Punto1.X, Punto1.Y, Punto1.Z);
...
// document.write("<br>fin rotacion punto vector<br>");
...
var P2 = new Punto3D (	SistCoord1.Origen.X + SistCoord1.VectorY.X,
...
var P0R = rotacionPuntoVector (Vector1, P0, anguloAlfa);
var VXR = rotacionVectorVector (Vector1, SistCoord1.VectorX, anguloAlfa);
var VYR = rotacionVectorVector (Vector1, SistCoord1.VectorY, anguloAlfa);
var VZR = rotacionVectorVector (Vector1, SistCoord1.VectorZ, anguloAlfa);
