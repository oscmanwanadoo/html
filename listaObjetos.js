...
//
// this.CuboContorno -> definición de cubo de contorno del objeto. Se forma con los 8 puntos del cubo de perímetro.
// this.SCL -> Sistema de Coordenadas Local.
// this.Ob_SCL -> objeto (dibujo de ejes) del Sistema de Coordenadas Local
//
// this.CuboContorno = new objeto3D (listavertices, listaaristas);
// this.SCL = new SistemaCoordenadas();
// this.Ob_SCL = new objeto3D();
...
[3,4]];
*/
var objson = { vertice : [[0,0,2],[2,0,2],[2,2,2],[0,2,2],[1,1,4]], 
arista :[[0,1],[1,2],[2,3],[3,0],[0,4],[1,4],[2,4],[3,4]]};



var ObjetoPiramide = new objeto3D(objson.vertice, objson.arista);
