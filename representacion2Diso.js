...
/*
// FUNCIONES PROYECCION PUNTO SOBRE VECTOR
// FUNCINO PROYECCION ORTIGONAL SOBRE CAMARA
// FUNCION PROYECCION PERSEPECTIVA SOBRE CAMARA
//
function proyeccionPuntoVector (Punto1, Vector1)
{
}

function proyeccionOrtogonal (Punto1, SistCoordCamara)
{
}

function proyeccionPerspectiva (Punto1, SistCoordCamara, distanciaFocal)
{
}
*/
...
function dibujaLinea (P1X, P1Y, P2X, P2Y, colorLinea, contexto)
	...
	// eje z
			...
			contexto.strokeStyle = '#0000cc';
			contexto.beginPath();
			contexto.moveTo(OX+50,OY-10);
			contexto.lineTo(OX-50,OY-60);
			contexto.stroke();
